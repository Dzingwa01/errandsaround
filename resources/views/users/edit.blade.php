                        ...
                        <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('surname') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="surname" id="input-surname" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Surname') }}" value="{{ $user->surname }}"  required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('contact_number') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="tel" name="contact_number" id="input-contact_number" class="form-control form-control-alternative{{ $errors->has('contact_number') ? ' is-invalid' : '' }}" placeholder="{{ __('Contact Number') }}" value="{{$user->contact_number}}"  required>
                                ...
                                <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="address" id="input-address" class="form-control form-control-alternative{{ $errors->has('address') ? ' is-invalid' : '' }}" placeholder="{{ __('Address') }}" >{{ $user->address }}</textarea>
                                </div>

...
@section('content')
    @include('users.partials.header', ['title' => __('Edit Service')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('service.update',$service->id) }}" enctype="multipart/form-data" autocomplete="on">
                            @method('put')
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('service_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="service_name" id="input-name"  class="form-control form-control-alternative{{ $errors->has('service_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Service Name') }}" value="{{$service->service_name}}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('service_description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="service_description" id="service-description" class="form-control form-control-alternative{{ $errors->has('service_description') ? ' is-invalid' : '' }}" placeholder="{{ __('Service Description') }}" >{{ $service->service_description }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" step="0.01" name="price" id="input-service-price" class="form-control form-control-alternative{{ $errors->has('price') ? ' is-invalid' : '' }}" placeholder="{{ __('Service Price') }}" value="{{ $service->price}}" required autofocus>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-sm-12">
                                        <img src="{{url('storage/'.$service->service_image_url)}}" id="previewing">
                                        <div class="file-field input-field" style="bottom:0px!important;">
                                            <label for="service_image_url" class="form-control-label">Update Service
                                                Image</label>
